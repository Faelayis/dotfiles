# Font
sudo dnf install google-noto-sans-fonts google-noto-sans-thai-fonts -y
sudo dnf install cascadia-code-fonts cascadia-code-pl-fonts cascadia-mono-fonts cascadia-mono-pl-fonts -y
